...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_Tab2.default, null), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TabItem = __webpack_require__(162);
	    ...
	    _createClass(Tab, [{
	        ...
	        value: function queryAllTabs() {
	            ...
	            pro.then(function (data) {
	                ...
	                _this2.setState({ tabsInfo: data });
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var tabListContent = this.state.tabsInfo.map(function (tab, i) {
	                return _react2.default.createElement(_TabItem2.default, _extends({ key: tab.id }, tab));
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabItem = function (_React$Component) {
	    ...
	    function TabItem(props) {
	        ...
	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(TabItem).call(this, props));
	
	        _this2.activateTab = _this2.activateTab.bind(_this2);
	        return _this2;
	    }
	    ...
	    _createClass(TabItem, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                "li",
	                { className: "tab-item", onClick: this.activateTab },
	                title,
	                _react2.default.createElement(
	                    "span",
	                    { className: "close", onClick: this.closeTab },
	                    "close"
	                )
	            );
	        }
